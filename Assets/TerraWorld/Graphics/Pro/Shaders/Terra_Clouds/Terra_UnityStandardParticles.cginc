#ifndef TERRA_UNITYSTANDARDPARTICLES_CGINC_INCLUDED
#define TERRA_UNITYSTANDARDPARTICLES_CGINC_INCLUDED
...
fixed _VisibilityDistance;
fixed _VisibilityFalloff;
fixed _VisibilityFalloffPower;
...
{
	fixed fader = clamp(1 - (pow(IN.cameraDistance / (_VisibilityDistance / _VisibilityFalloff), _VisibilityFalloffPower)), 0.0, 1.0);
...
#endif // TERRA_UNITYSTANDARDPARTICLES_CGINC_INCLUDED
