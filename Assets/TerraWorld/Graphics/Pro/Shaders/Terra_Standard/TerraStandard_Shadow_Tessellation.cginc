...
#ifndef TERRASTANDARD_SHADOW_TESSELLATION_CGINC_INCLUDED
#define TERRASTANDARD_SHADOW_TESSELLATION_CGINC_INCLUDED
...
#include "TerraStandard_Tessellator.cginc"
...
TessData vs_tess (VertexInput v) {
  TessData o = (TessData)0;
    ...
    FlatShading(v.vertex.xyz, v.normal, worldNormal, v.uv0);
#endif

    // Wind Simulation
#ifdef _WIND
    WindSimulation(v.vertex.xyz, v.uv0.y);
#endif
...
#endif // TERRASTANDARD_SHADOW_TESSELLATION_CGINC_INCLUDED
