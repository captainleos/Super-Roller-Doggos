Shader "Hidden/TerraUnity/TerraFormer_AddPass"
{
    ...
    SubShader
    {
        ...
        CGPROGRAM
		#pragma surface surf Standard vertex:SplatmapVert finalcolor:SplatmapFinalColor finalgbuffer:SplatmapFinalGBuffer addshadow fullforwardshadows tessellate:tessEdge tessphong:_Phong noinstancing nolightmap nodirlightmap nodynlightmap halfasview nometa //noforwardadd decal:add
