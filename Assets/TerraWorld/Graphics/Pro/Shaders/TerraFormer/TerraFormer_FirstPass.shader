Shader "TerraUnity/TerraFormer"
{
    Properties
	{
		...
		_SnowThickness ("Thickness", Range(0, 10)) = 1
    ...
    SubShader
	{
        ...
        CGPROGRAM
		#pragma surface surf Standard vertex:SplatmapVert finalcolor:SplatmapFinalColor finalgbuffer:SplatmapFinalGBuffer addshadow fullforwardshadows tessellate:tessEdge tessphong:_Phong noinstancing nolightmap nodirlightmap nodynlightmap halfasview nometa //noforwardadd
