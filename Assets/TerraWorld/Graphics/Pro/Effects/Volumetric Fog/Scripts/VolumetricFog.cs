...
namespace TerraUnity.Runtime
{
	...
	public class VolumetricFog : MonoBehaviour
	{
		...
		[MinValue(0.1f)]
		public float m_FarClipMax = 300.0f;
		...
		// Density
		public float m_ConstantFog = 0.2f;
		...
		[Range(0.0f, 1.0f)]
		public float m_NoiseFogAmount = 0.8f;
		public float m_NoiseFogScale = 0.1f;
		public WindManager m_Wind;
		...
		public float m_GlobalIntensityMult = 4.0f;
		[MinValue(0)]
		public float m_AmbientLightIntensity = 2.0f;
		...
		void SetUpForScatter(int kernel)
		{
			...
			m_InjectLightingAndDensity.SetFloat("_WindSpeed", m_Wind == null ? 100 : m_Wind.m_Speed);
