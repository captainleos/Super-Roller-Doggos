...
namespace TerraUnity.Edittime
{
    public class TPolygon
    {
        ...
        private void RemoveEar(List<TTriangle> triangles)
        {
            // Find an ear.
            int A = 0, B = 0, C = 0;
            ...
            triangles.Add(new TTriangle(Points[A], Points[B], Points[C]));
        ...
        public List<TTriangle> Triangulate()
        {
            ...
            TPolygon pgon = new TPolygon(pts);
            ...
            triangles.Add(new TTriangle(pgon.Points[0], pgon.Points[1], pgon.Points[2]));
    ...
    public class TTriangle : TPolygon
    {
        public TTriangle(PointF p0, PointF p1, PointF p2)
        {
