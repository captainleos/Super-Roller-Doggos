...
namespace TerraUnity.TriangleNet.Meshing
{
    using System;
    using System.Collections.Generic;
    using TerraUnity.TriangleNet.Geometry;
    using TerraUnity.TriangleNet.Logging;
    using TerraUnity.TriangleNet.Meshing.Iterators;
    using TerraUnity.TriangleNet.Topology;
