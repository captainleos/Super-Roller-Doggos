...
public class TMatrix
{
    ...
    public static Vector2 ExtractTranslationFromMatrix2D(ref Matrix4x4 matrix)
    {
        Vector2 translate;
        translate.x = matrix.m03;
    ...
    public static Quaternion ExtractRotationFromMatrix(ref Matrix4x4 matrix)
    {
        ...
        else if (forward != Vector3.zero && upwards != Vector3.zero) return Quaternion.LookRotation(forward, upwards);
        else if (forward == Vector3.zero && upwards != Vector3.zero) return Quaternion.LookRotation(upwards);
        else if (upwards == Vector3.zero && forward != Vector3.zero) return Quaternion.LookRotation(forward);
