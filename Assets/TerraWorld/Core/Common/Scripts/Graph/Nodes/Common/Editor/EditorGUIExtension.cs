...
/*
 * 
 * Code is copyed from : "Terra Project"
 * Terra is an infinite procedural terrain mesh generator that allows you to quickly create terrain both visually and programmatically. 
 * Customizing the procedural generation pipeline is simple yet powerful through the use of Terra’s generation API. Any generator created 
 * visually can be implemented programmatically allowing you to tailor generation to the specifics of your game.
 * 
 * Registered for  walkerc
 * 
 * support@walkerc.me
 * 
 * 
